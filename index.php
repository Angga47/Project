...
<html>
	<head>
		...
		<meta name="keywords" content="DEVart" />
		<meta name="description" content="DEVart">
		<meta name="author" content="Angga Permana">
			...
			<header id="header" data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 57, "stickySetTop": "-57px", "stickyChangeLogo": true}'>
				...
				<div class="container">
					<div class="row mt-xl">
						<div class="col-md-12 center">
							<h2 class="mt-xl mb-none">Apa yang <strong>Kami Kerjakan</strong></h2>
								...
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#tabsNavigationSimpleIcons1" data-toggle="tab">
											...
											<p class="mb-none pb-none">Strategi</p>
										</a>
									</li>
									<li>
										<a href="#tabsNavigationSimpleIcons2" data-toggle="tab">
											...
											<p class="mb-none pb-none">Kreatif</p>
										</a>
									</li>
									<li>
										<a href="#tabsNavigationSimpleIcons3" data-toggle="tab">
											...
											<p class="mb-none pb-none">Pengembangan</p>
										</a>
									</li>
									<li>
										<a href="#tabsNavigationSimpleIcons4" data-toggle="tab">
											...
											<p class="mb-none pb-none">Pemasaran</p>
										</a>
									</li>
								</ul>
				...
				<section class="mt-xl mb-none pb-none">
					<div class="container">
						<div class="row">
							<div class="col-md-12 center">
								<h2 class="mt-xl mb-none"><strong>Proyek</strong> Baru</h2>
								<div class="divider divider-primary divider-small divider-small-center mb-xl">
									<hr>
								</div>
							</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 center">
								<div class="row">
									<div class="col-md-12 center">
										<h2 class="mb-xl mb-none text-dark">Who <strong>Loves Us</strong></h2>
										<div class="divider divider-primary divider-small divider-small-center mb-xl">
											<hr>
										</div>
									</div>
